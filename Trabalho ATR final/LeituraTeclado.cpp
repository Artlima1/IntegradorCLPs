...
struct mensagem_alarme
{
 ...
 //***** Leitura1 é a primeira leitura de dados do CLP/ Leitura2 é a segunda thread de leitura de dados// Leitura 3 é a thread de leitura de alarmes// Retirada é a thread de retirada das mensagens// Dados e Alarme são as mesmas
...
int main()
{
	...
	Bloq_Leitura3 = CreateEvent(NULL, TRUE, FALSE, "Monitoração"); // MUDAR NOME
	...
	*/
	...
	Retorno = WaitForMultipleObjects(7, Thread_Gusa, TRUE, INFINITE); //Função de espera do fechamento das threads
